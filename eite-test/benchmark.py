...
TASK_SUITE: List[Dict] = [
    ...
    # ===== L1: 简单代码生成 =====
    {
        ...
        "eval": 'python3 /tmp/.eval_L1_pal.py',
        "timeout": 60,
        "requires_tools": True,
    },
    {
        ...
        "eval": 'python3 /tmp/.eval_L1_fib.py',
        "timeout": 60,
        "requires_tools": True,
    },
    {
    ...
    # ===== L2: 多步骤工程任务 =====
    {
        ...
        "eval": 'python3 /tmp/.eval_L2_sort.py',
        "timeout": 120,
        "requires_tools": True,
    },
    {
        ...
        "eval": 'python3 /tmp/.eval_L2_web.py',
        "timeout": 120,
        "requires_tools": True,
    },
    {
        ...
        "eval": 'python3 /tmp/.eval_L2_grep.py',
        "timeout": 120,
        "requires_tools": True,
    },
    ...
    # ===== L3: 复杂系统任务 =====
    {
        ...
        "eval": 'python3 /tmp/.eval_L3_diff.py',
        "timeout": 180,
        "requires_tools": True,
    },
    {
